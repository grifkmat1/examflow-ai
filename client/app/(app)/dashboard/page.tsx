    ...
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      {!loading && conflicts.length > 0 && (
        <div className="space-y-2">
          <p className="text-[11px] font-semibold text-white/40 uppercase tracking-wider">Conflicts</p>
      ...
      <div>
        ...
        {loading ? (
          ...
          <Card><EmptyState icon="📅" title="No exams yet" desc="Add your first exam to start tracking your schedule." action={<Link href="/exams" className="text-xs bg-emerald-500 text-black font-semibold px-4 py-1.5 rounded-lg mt-2 inline-block">Add exam</Link>} /></Card>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            {exams.slice(0,6).map(exam => (
              <Card key={exam.id} hover className="p-4">
                ...
                <h3 className="text-sm font-semibold text-white/85 mb-2 leading-tight">{exam.course_title}</h3>
